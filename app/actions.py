...
SHOP_ACTIONS = [
    ...
    {
        "intent": PlayerIntent.DEPOSIT_GOLD,
        "label": "Deposit Gold",
        "description": "Add gold to your party stash."
    },
    {
        "intent": PlayerIntent.WITHDRAW_GOLD,
        "label": "Withdraw Gold",
...
QUERY_ACTIONS = [
    {
        "intent": PlayerIntent.CHECK_BALANCE,
        "label": "Check Balance",
        "description": "See how much gold your party currently holds."
    },
    {
        "intent": PlayerIntent.VIEW_ITEMS,
        "label": "View Items",
        "description": "Look at the list of items available in the shop."
    },
    {
        "intent": PlayerIntent.VIEW_LEDGER,
        "label": "View Ledger",
