...
class BuyHandler(HandlerDebugMixin):
    ...
    def __init__(self, convo, agent, party_id, character_id, player_id, player_name, party_data):
    ...
    def handle_haggle(self, player_input):
        ...
        haggle = HaggleHandler(self.agent, self.convo, self.party_data, self.character_id)
        # Just return the *actual message* generated by attempt_haggle:
